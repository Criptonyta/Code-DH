...
RELACIONES 1:N => Ej. "Un usuario tiene muchas imágenes y una imagen pertenece a un usuario". Sequelize utiliza dos funciones para administrar estas relaciones: a) HAS MANY (tiene muchos) y b) BELONGS TO (pertenece a), usando associate() en conjunto con el metodo define() para determinar esa relacion:
