...
const uploadFile = multer({storage:storage}); // configuro la ruta encargada de subir los archivos (la que indicamos en el action del formulario). Debe aplicarse en cada archivo que requiera una ruta para la subida de archivos
